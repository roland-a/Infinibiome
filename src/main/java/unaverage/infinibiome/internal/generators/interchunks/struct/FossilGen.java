...
public final class FossilGen extends SmallObjectGenBase implements Locatable.HasPointsProvider {
    public FossilGen(DependencyInjector di) {
        super(di, Infinibiome.MOD_ID + ":fossil");

        config = initConfig()
            .setWithFeature(
                new FossilsFeatureFixed(NoFeatureConfig::deserialize)
            )
            .setCount(1)
            .setAttemptsPerCount(4)
            .customHeightFunc(
                (pos, world, random) -> MCHelper.getHighestTerrainHeight(pos, world) - 5
            )
            .setChancePerChunk(1/300f)
            .addExtraConditions(
    ...
    private static class FossilsFeatureFixed extends Feature<NoFeatureConfig> {
        ...
        public FossilsFeatureFixed(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i49873_1_) {
            super(p_i49873_1_);
        }
        ...
        public boolean place(IWorld p_212245_1_, ChunkGenerator<? extends GenerationSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, NoFeatureConfig p_212245_5_) {
            ...
            PlacementSettings lvt_15_1_ = (new PlacementSettings()).setRotation(lvt_8_1_).setBoundingBox(lvt_14_1_).setRandom(lvt_6_1_).addProcessor(
            ...
            //only modification
            BlockPos lvt_21_2_ = lvt_11_1_.getZeroPositionWithTransform(p_212245_4_, Mirror.NONE, lvt_8_1_);
            IntegrityProcessor lvt_22_1_ = new IntegrityProcessor(0.9F);
            lvt_15_1_.clearProcessors().addProcessor(lvt_22_1_);
            lvt_11_1_.addBlocksToWorld(p_212245_1_, lvt_21_2_, lvt_15_1_, 4);
            lvt_15_1_.removeProcessor(lvt_22_1_);
            IntegrityProcessor lvt_23_1_ = new IntegrityProcessor(0.1F);
            lvt_15_1_.clearProcessors().addProcessor(lvt_23_1_);
